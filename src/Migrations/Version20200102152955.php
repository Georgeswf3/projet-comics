 ...
 */
final class Version20200102152955 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fan_art (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, user_id_id INT NOT NULL, fan_art_title VARCHAR(255) NOT NULL, fan_art_hook VARCHAR(255) DEFAULT NULL, fan_art_sketch VARCHAR(255) NOT NULL, is_confirmed TINYINT(1) NOT NULL, INDEX IDX_BAA3C0F675F31B (author_id), INDEX IDX_BAA3C09D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, article_title VARCHAR(255) NOT NULL, article_text LONGTEXT NOT NULL, article_date DATETIME NOT NULL, is_confirmed TINYINT(1) NOT NULL, INDEX IDX_23A0E669D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, article_id_id INT NOT NULL, fan_art_id_id INT NOT NULL, comment_article LONGTEXT NOT NULL, comment_fan_art LONGTEXT NOT NULL, is_confirmed TINYINT(1) NOT NULL, INDEX IDX_9474526C9D86650F (user_id_id), INDEX IDX_9474526C8F3EC46 (article_id_id), INDEX IDX_9474526CA1DC27C7 (fan_art_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
