 ...
 */
final class Version20191227144810 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fan_art ADD author_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE fan_art ADD CONSTRAINT FK_BAA3C0F675F31B FOREIGN KEY (author_id) REFERENCES author (id)');
        $this->addSql('CREATE INDEX IDX_BAA3C0F675F31B ON fan_art (author_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_BAA3C0F675F31B ON fan_art');
        $this->addSql('ALTER TABLE fan_art DROP author_id');
    }
}
